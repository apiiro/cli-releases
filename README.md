...
```bash
npx skills add apiiro/cli-releases --skill apiiro-scan
npx skills add apiiro/cli-releases --skill apiiro-risks
npx skills add apiiro/cli-releases --skill apiiro-guardian
```
...
Quick local scanning for secrets and OSS vulnerabilities. Auto-detects changed files in the current git repo.
...
List and inspect risks for a repository.
...
Query Apiiro's AI agent for security analysis and insights.
